...
<template>
    <template v-if="1 === info.event">
        ...
        <polyline v-else-if="'polyline' === type || 'pencil' === type" :class="[style.stroke_animation]"
            :points="attr.points" :fill="style.fill" :stroke="style.stroke" :stroke-width="style.stroke_width"
            :stroke-dasharray="style.stroke_dasharray" :stroke-linecap="style.stroke_linecap">
        </polyline>
